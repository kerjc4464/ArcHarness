...
* **三库查看** — EXtreme (`:9001` events/short_pool/sublimated/chats) + ViGil (`:9000` tasks/messages) 表格化, 含 2bit 下拉直改 (`+1/-1` 循环直达)。Fess (`:8999`) 复用自带 `Arc Databoard.html / QueryLab / StoryMap / FlowLab` iframe 内嵌, 不重造。
